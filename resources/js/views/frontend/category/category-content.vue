                        ...
                        <form action="./database/connect.php" method="post" enctype="multipart/form-data">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="category_name" id="category-name" value="">
                                </div>
                                <div class="form-group">
                                    <label for="message-text" class="col-form-label">Image:</label>
                                    <a id="category-update-output-image" href="" class="fancybox-button" data-rel="fancybox-button">
                                        <img class="img-responsive"
                                             id="category-update-output"
                                             src="./uploads/SHIQA.png"
                                             alt="">
                                    </a>
                                    <input type="file" onchange="categoryUpdatLoadFile(event)" name="category_image"  id="category-update-image_upload" accept=".jpg, .png, .tif, .jpeg">
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="submit" name="update_category"  class="btn blue">Save changes</button>
...
//                                            <tr role="row">
                                    ...
                                    //                                                <td>
                                        //                                                    <a id="output-image" href="uploads/'. $row['category_image'] .'"
                                        //                                                                        class="fancybox-button" data-rel="fancybox-button">
                                        //                                                        <img class="img-responsive" src="./uploads/'. $row['category_image'] .'">
                                        //                                                    </a>
                                        //                                                </td>
                                    //                                                <td>
                                        //                                                    <button type="button" name="category" id="'.$row["category_id"].'" class="edit btn btn-primary">EDIT</button>
                                        //                                                    <button type="button" id="d'.$row["category_id"].'" class="delet btn btn-danger">Delet</button>
                                        //                                                </td>
                                    //                                            </tr>
                                    //                                        ';
                                    //                                    };
