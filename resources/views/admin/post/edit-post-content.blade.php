                    ...
                    <div class="row py-1">
                        <div class="col-sm-12">
                            <div class="input-group titlewrap">
                                <input type="text" name="author_id" value="{{$post->author_id}}" class="form-control rounded" placeholder="Title" aria-label="Title" aria-describedby="basic-addon2">
                            </div>
                        </div>
                    </div>
                    <div class="row py-1">
                        <div class="col-sm-12">
                            <div class="input-group titlewrap">
                                <input type="text" name="title" value="{{$post->title}}" class="form-control rounded" placeholder="Title" aria-label="Title" aria-describedby="basic-addon2">
                            </div>
                        </div>
                    </div>
                    <div class="row py-1">
                        ...
                        <div class="col-sm-12">
                            <form action="#" class="form-horizontal form-bordered">
                                <div class="form-body">
                                    <div class="form-group last">
                                        <div class="col-md-12">
                                            <textarea class="ckeditor form-control" name="short_description" rows="6">
                                                {{$post->description}}
                                            </textarea>
                                        </div>
                                    </div>
                            ...
                            <div class="portlet box grey">
                                ...
                                <div class="portlet-body">
                                    <div class="row py-1">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="text" name="meta_title" value="{{$post->meta_title}}" class="form-control rounded"  placeholder="About us" aria-label="About us" aria-describedby="basic-addon1">
                                            </div>
								...
								<span>
                                    ...
                                    <div class="py-1">
                                        ...
                                        <span>Draft</san>
                                            <a href="#">Edit</a>
                                        <div>
                                        <select class="custom-select rounded " name="status" value="{{$post->status}}>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="portlet box grey">
                                ...
                                <div class="portlet-body">
                                    <div class="py-1">
                                        Parent <br>
                                        <select name="parent_id" value="{{$post->parent_id}} class="custom-select rounded">
                                            <option selected>no parent</option>
                                            <option value="1">One</option>
                                            <option value="2">Two</option>
                                            <option value="3">Three</option>
