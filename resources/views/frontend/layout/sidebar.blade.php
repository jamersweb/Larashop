                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="{{url('category-list')}}">
                                <i class="icon-pencil"></i>Category</a>
                        </li>
                        <li>
                            <a href="{{url('category-edit')}}">
                                <i class="icon-pencil"></i>Add Category</a>
                        </li>
                        <li>
                            <a href="{{url('subcategory-list')}}">
                                <i class="icon-pencil"></i>Sub Category</a>
                        </li>
                        <li>
                            <a href="s{{url('subcategory-edit')}}">
                                <i class="icon-pencil"></i>Add New Sub Category</a>
                        </li>
                    </ul>
                </li>
                <li>
