    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form class="form-horizontal form-row-seperated" method="POST" action="{{url('/update')}}">
                    @csrf
                    @method('PUT')
                    <div class="portlet">
                                    ...
                                    <div class="tab-pane active" id="tab_general">
                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="user_Id" placeholder="user id" value="{{$data->user_Id}}">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-control height-auto categories" >
...
{{--                                <form action="Get" method="{{route('product'.$data->id)}}">--}}
{{--                                    @csrf--}}
{{--                                    @method('PUT')--}}
